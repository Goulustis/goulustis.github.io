...
This project is inspired by 3D wire-art paper I saw. Their work looks really cool. But:
...
I followed the paper and extend a 2D differentiable renderer to 3D. I, then, mimize the MSE loss between the rendering of the differentiable renderer and the target image to obtain a list 3D bezier curves. The direct extension of the differentiable renderer do not work too well. I added a bunch of secret sauces to get it working reasonably.
